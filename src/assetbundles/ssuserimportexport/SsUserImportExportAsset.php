...
namespace ssplugin\ssuserimportexport\assetbundles\SsUserImportExport;
...
/**
 * SsUserImportExportAsset AssetBundle
 *
 ...
 * @since     1.0.0
 */
class SsUserImportExportAsset extends AssetBundle
{
    // Public Methods
    // =========================================================================
    ...
    public function init()
    {
        ...
        $this->js = [
            'js/SsUserImportExport.js',
        ];

        $this->css = [
            'css/SsUserImportExport.css',
        ];
